...
public class TestStraight {
    ...
    @Test
    public void should_return_true_when_the_is_a_straight_to_as() {
        // given
        ...
        Card card7 = DataFactory.getCard(LabelCard.PIQUE, NumberCard.DIX);
        // when
        List<Card> royalFlushCards = Arrays.asList(card1, card2, card3, card4, card5, card6, card7);
        Hand royalFlushCombination = new Straight(royalFlushCards);
        // then
